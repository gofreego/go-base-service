...
/*
Package gobaseservice_v1 is a reverse proxy.
...
func RegisterBaseServiceHandlerServer(ctx context.Context, mux *runtime.ServeMux, server BaseServiceServer) error {
	...
	mux.Handle("GET", pattern_BaseService_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		annotatedContext, err = runtime.AnnotateIncomingContext(ctx, mux, req, "/v1.BaseService/Ping", runtime.WithHTTPPathPattern("/gobaserservice/v1/ping"))
		if err != nil {
...
func RegisterBaseServiceHandlerClient(ctx context.Context, mux *runtime.ServeMux, client BaseServiceClient) error {
	...
	mux.Handle("GET", pattern_BaseService_Ping_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		...
		var err error
		var annotatedContext context.Context
		annotatedContext, err = runtime.AnnotateContext(ctx, mux, req, "/v1.BaseService/Ping", runtime.WithHTTPPathPattern("/gobaserservice/v1/ping"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
...
var (
	pattern_BaseService_Ping_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2}, []string{"gobaserservice", "v1", "ping"}, ""))
)
