...
class StatsRequest extends $pb.GeneratedMessage {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatsRequest', package: const $pb.PackageName(_omitMessageNames ? '' : 'v1'), createEmptyInstance: create)
...
class StatsResponse extends $pb.GeneratedMessage {
  factory StatsResponse({
    ...
    if (totalPermissions != null) {
      $result.totalPermissions = totalPermissions;
    }
    if (totalGroups != null) {
  ...
  static final $pb.BuilderInfo _i = $pb.BuilderInfo(_omitMessageNames ? '' : 'StatsResponse', package: const $pb.PackageName(_omitMessageNames ? '' : 'v1'), createEmptyInstance: create)
    ..aInt64(1, _omitFieldNames ? '' : 'totalUsers')
    ..aInt64(2, _omitFieldNames ? '' : 'totalPermissions')
    ..aInt64(3, _omitFieldNames ? '' : 'totalGroups')
    ..aInt64(4, _omitFieldNames ? '' : 'activeUsers')
    ..hasRequiredFields = false
  ;
